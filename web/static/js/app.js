...
let localVideo = document.getElementsByTagName("video")[0];
let remoteVideo = document.getElementsByTagName("video")[1];
let connectButton = document.getElementsByTagName("button")[0];
let callButton = document.getElementsByTagName("button")[1];
let hangupButton = document.getElementsByTagName("button")[2];
